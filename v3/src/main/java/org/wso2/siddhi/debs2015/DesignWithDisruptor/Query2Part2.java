...
public class Query2Part2 {
    ...
    public ExecutionPlanRuntime addExecutionPlan() {
        ...
        String taxiTripStream = " define stream profitStream ( profit float, startCellNo string, endCellNo string , pickup_datetime long ,  dropoff_datetime long ,  medallion string ," +
