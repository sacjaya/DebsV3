...
//
//
//public class Query2WithIndexedTable {
...
//        Query2WithIndexedTable query1Obj = new Query2WithIndexedTable();
//        query1Obj.run();
//    }
//
//    public void run(){
...
//                "from every e1 = filtered_cell_based_taxi_trips -> e2 = filtered_cell_based_taxi_trips [(e1.medallion == e2.medallion) or (e2.dropoff_datetime-e1.dropoff_datetime)>=1800000]  " +
