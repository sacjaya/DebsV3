...
//	    System.out.println("Started experiment at : " + System.currentTimeMillis());
        ...
        extensions.put("MaxK:getMaxK", MaxKTimeTransformerQuery1.class);
...
//        		insert into filteredSensorStream;
        ...
        String query4 = "@info(name = 'query4') " +
                "from countStream#MaxK:getMaxK(tripCount, startCellNo, endCellNo, 10, iij_timestamp, pickup_datetime_org, dropoff_datetime_org) " +
                "select * " +
