...
public class Query2Part3 {
    ...
    public ExecutionPlanRuntime addExecutionPlan() {
        ...
        String profitRawData = " define stream profitRawData (cellNo string, profit float, emptyTaxiCount int, pickup_datetime long ,  dropoff_datetime long ," +
                " iij_timestamp long ); ";
        ...
        String query2 = "@info(name = 'query5') " +
        ...
        return siddhiManager.createExecutionPlanRuntime("@Plan:name('Query2-MaxK')"+profitRawData + query1 + query2);
