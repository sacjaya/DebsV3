package org.wso2.siddhi.debs.query;
...
import org.wso2.siddhi.debs.extensions.cellId.CellIdFunction;
import org.wso2.siddhi.debs.extensions.maxK.MaxKTimeTransformerCopy;
import org.wso2.siddhi.debs.extensions.median.MedianAggregator;
import org.wso2.siddhi.debs.extensions.timeStamp.TimeStampFunction;
import org.wso2.siddhi.debs.util.Config;
import org.wso2.siddhi.debs.util.Constants;
...
public class Query1 {
	...
	public static void main(String[] args) {
        ...
        String taxiTripStream = "define stream taxi_trips ( medallion string , hack_license string ,  pickup_datetime string, dropoff_datetime string , trip_time_in_secs int, " +
                "trip_distance float, pickup_longitude float,  pickup_latitude float,  dropoff_longitude float,  dropoff_latitude float , payment_type string ,  fare_amount float, " +
                "surcharge float, mta_tax float, tip_amount float, tolls_amount float, total_amount float, iij_timestamp float); ";
        ...
        ExecutionPlanRuntime executionPlanRuntime = siddhiManager.createExecutionPlanRuntime(taxiTripStream+query1+query2+query3+query4+query5);
